...
const Contact = () => {
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        I’d love to hear from you! If you have any questions, suggestions, or feedback, please feel free to fill out the form below.</motion.p>
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
          ...
          className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='message'></motion.textarea>
