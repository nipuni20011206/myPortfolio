    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            transition={{duration: 0.6, delay: 0.8}}className='flex-1'>
                ...
                className='my-6 text-gray-700 font-Ovo text-sm dark:text-white/80' >Tools I use</motion.h4>

                <motion.ul 
                initial={{opacity: 0}}
                whileInView={{opacity: 1}}
                transition={{duration: 1.5, duration: 0.6}}className='flex items-center gap-3 sm:gap-5'>
