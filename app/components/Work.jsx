...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work'className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my web development portfolio! Explore a collection of projects 
            showcasing my expertise in front-end development and creating engaging user experiences...</motion.p>
                ...
                {workData.map((project, index)=>(
                    ...
                    style={{backgroundImage: `url(${project.bgImage})`}}>
                        ...
                        justify-between duration-500 group-hover:bottom-7'>
                            <div>
                                <h2 className='font-semobold'>{project.title}</h2>
